...
export class AwsVpcStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    //
    // One Security Group to use across all new VPC Endpoints and
    ...
    this.securityGroup = new ec2.SecurityGroup(
      this,
      "grimoire-security-group",
      {
        securityGroupName: this.resourceName("security-group"),
        vpc: this.vpc,
      }
    );

    //
    // Allow access to all ports for Grimoire Lab
